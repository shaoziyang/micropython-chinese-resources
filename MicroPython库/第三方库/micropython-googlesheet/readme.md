...
添加、获取或更新数据到 Google 表格，使用 HTTP 来执行 Google Apps Script API。兼容ESP32。

## 使用方法

- [安装](https://github.com/PerfecXX/MicroPython-GoogleSheet/blob/main/doc/md/installation.md)
- [获取谷歌证书](https://github.com/PerfecXX/MicroPython-GoogleSheet/blob/main/doc/md/get_google_credential.md)
...
- [仓库地址](https://github.com/PerfecXX/MicroPython-GoogleSheet)
